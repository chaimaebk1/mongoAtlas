...
const Footer = () => {
  return (
    ...
    <footer className="bg-white rounded-lg shadow mt-4" style={{backgroundColor : "#1E1916"}}>
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">MongoDbPatisserie™</a>. All Rights Reserved.</span>
      </div>
    </footer>
