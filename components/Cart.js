    ...
    >
      ...
      <div className="mt-8">
        <form className="flex items-center justify-center">
          ...
          />
          <button className="ml-3 flex items-center px-3 py-2  text-white text-sm uppercase font-medium rounded hover:bg-green-500 focus:outline-none focus:bg-green-500" style={{backgroundColor : "#eaa636"}}>
            <span>Apply</span>
          </button>
        </form>
      </div>
      <a className="flex items-center justify-center mt-4 px-3 py-2 bg-green-600 text-white text-sm uppercase font-medium rounded hover:bg-green-500 focus:outline-none focus:bg-green-500 cursor-pointer"style={{backgroundColor : "#eaa636"}}>
        <span>Chechout</span>
